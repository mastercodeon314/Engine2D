...
public class SceneScriptList
{
	private ArrayList<IScript> IScripts;
	//public long Uid;
	public SceneScriptList()
	{
	...
	public SceneScript[] ToArray()
	{
		SceneScript[] Result = new SceneScript[this.IScripts.size()];
		Object[] Objs = this.IScripts.toArray();

		for (int i = 0; i < Result.length; i++)
		{
			Result[i] = (SceneScript)Objs[i];
		}
